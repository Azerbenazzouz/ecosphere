...
import { BarChart2, CheckCircle, DollarSign, TrendingUp } from 'lucide-react'

const Subscription = () => {
    const plans = [
        { name: "Basic", price: "29 TND", period: "par mois", disactive: true, 
          features: [
        ...
        { name: "Pro", price: "99 TND", period: "par mois", disactive: true, features: [
        ...
        { name: "Enterprise", price: "299 TND", period: "par mois", disactive: true , features: [
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card key={plan.name} className="flex flex-col border rounded-lg shadow-lg hover:shadow-xl transition-shadow bg-white width-full">
                    ...
                    <div className="p-6 mt-auto">
                        <Button className="w-full py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-colors" disabled={plan.disactive}>
                            Soon...
                        </Button>
                    </div>
                </Card>
